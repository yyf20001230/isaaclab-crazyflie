...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        breakpoint() # what is _actions here
    ...
    def _get_rewards(self) -> torch.Tensor:
        # input state: angular speed, linear speed, gravity vector (orientation), height(z)
        # target state: 0,0,0,z (x, y does not matter)
        # task: in training, start from ground, aim to hover at 1m, fixed
        # reward: a slight redesign for distance to desired height
        # --- before starting, do research on sensor reading ---
